 ...
 *
 * Output: docs/screenshots/v3/{page}-{viewport}-{w}x{h}.png (20 files)
 */
...
const OUT = resolve(__dirname, "../docs/screenshots/v3");
...
await browser.close();
console.log("\nDone. 20 screenshots saved to docs/screenshots/v3/");
